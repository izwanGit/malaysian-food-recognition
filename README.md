...
```mermaid
flowchart TD
    A["📷 Input Image<br/>224×224×3"] --> B["🔷 Conv1<br/>64 filters, 7×7"]
    B --> C["📦 Res Block 1<br/>64 filters"]
    C --> D["📦 Res Block 2<br/>128 filters"]
    D --> E["📦 Res Block 3<br/>256 filters"]
    E --> F["📦 Res Block 4<br/>512 filters"]
    F --> G["🔄 Global Avg Pool"]
    G --> H["🧠 FC Layer<br/>7 classes"]
    H --> I["🎯 Food Classification"]
...
```mermaid
flowchart TD
    subgraph ENCODER["🔷 ENCODER (ResNet18)"]
        E1["Conv1<br/>512→256"] --> E2["Res1<br/>256→128"]
        E2 --> E3["Res2<br/>128→64"]
        E3 --> E4["Res3<br/>64→32"]
        E4 --> E5["Res4<br/>32→16"]
    end
    
    subgraph ASPP["🌐 ASPP MODULE"]
        A1["1×1 Conv"]
        A2["Atrous r=6"]
        A3["Atrous r=12"]
        A4["Atrous r=18"]
    ...
    subgraph DECODER["🔶 DECODER"]
        D1["Concat Features"] --> D2["3×3 Conv"]
        D2 --> D3["Upsample 4×"]
        D3 --> D4["3×3 Conv"]
        D4 --> D5["Upsample 4×"]
    end
    
    INPUT["📷 Input<br/>512×512"] --> ENCODER
    E5 --> A1 & A2 & A3 & A4 & A5
    A1 & A2 & A3 & A4 & A5 --> D1
    E2 -.->|Low-level features| D1
    D5 --> OUTPUT["🎯 Segmentation Mask<br/>512×512"]
