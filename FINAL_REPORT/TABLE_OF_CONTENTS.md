...
3.3 Image Processing Techniques Used
   ...
   - 3.3.2 Feature Extraction (Color Histograms, GLCM Texture)
   - 3.3.3 Classification (SVM with Cross-Validation, CNN with Transfer Learning)
   - 3.3.4 Segmentation (HSV Threshold, Morphology, Chan-Vese)
...
4.3 Parameter Settings
   ...
   - 4.3.2 SVM Hyperparameters
   - 4.3.3 CNN Training Parameters
